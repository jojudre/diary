...
const Sort = ({ className }: { className?: string }) => (
    ...
    >
        <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            <g transform="translate(-341.000000, -1532.000000)">
