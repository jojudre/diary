...
const HomeView: FC = () => {
  const { notes, searchValue, addNote, deleteNote, setSearchValue, sortByCreated, sortByUpdated } = useDiaryState();
  ...
  return (
    <div className={css.homePage}>
      ...
      <div className={css.toolbar}>
        ...
        />
        <SortButton onSortByCreated={handleSortByCreated} onSortByUpdated={handleSortByUpdated} />
      </div>
